...
# sql:
	...
	RESULT1="$(mariadb --host=192.168.0.153 --skip-column-names --user=jannetta --password=j0nn3tt0 workshopadmin < script1.sql)"
	RESULT2="$(mariadb --host=192.168.0.153 --skip-column-names --user=jannetta --password=j0nn3tt0 workshopadmin < script2.sql)"
	RESULT3="$(mariadb --host=192.168.0.153 --skip-column-names --user=jannetta --password=j0nn3tt0 workshopadmin < script3.sql)"
	RESULT4="$(mariadb --host=192.168.0.153 --skip-column-names --user=jannetta --password=j0nn3tt0 workshopadmin < script4.sql)"
