...
ALTER TABLE `workshops`
  ...
  ADD KEY `carpentry` (`carpentry_code`),
  ADD KEY `room` (`room_id`),
  ADD KEY `flavour` (`flavour_id`),
  ADD KEY `curriculum` (`curriculum_code`);
...
--
ALTER TABLE `emails`
  ADD CONSTRAINT `contact` FOREIGN KEY (`person_id`) REFERENCES `people` (`person_id`),
  ADD CONSTRAINT `workshop` FOREIGN KEY (`slug`) REFERENCES `workshops` (`slug`);

--
-- Constraints for table `helpers`
--
ALTER TABLE `helpers`
  ADD CONSTRAINT `helpers` FOREIGN KEY (`person_id`) REFERENCES `people` (`person_id`),
  ADD CONSTRAINT `slug` FOREIGN KEY (`slug`) REFERENCES `workshops` (`slug`);
